...
public class AddingsupplierAndsearch {
...
//	Sheet sh = wb.getSheet("Sheet4");
	...
	// Adding supplier
		...
		Thread.sleep(2000);
		String companyname = eLib.readDataFromExcel("Sheet7",0,1);
		String phonenumber = eLib.readDataFromExcel("Sheet7",1,1);
